...
function()
{
    ...
    /* pure function to calculate the new distance based on speed */
    function calculateNewDistance(currentDistance, speed)
    {
        return currentDistance - (speed / 60); /* assuming update every second */
    }

    /* pure function to display the distance */
    ...
    /* pure function to update the distance and return the new state */
    ...
    function startGalactusDistanceTracker()
    {
        ...
        /* function to perform the entire update cycle */
        function updateCycle()
        {
            state = updateDistance(state); /* get new state with updated distance */
